...
const MainLayout = () => {
  ...
  // Fetch the live balance every time the user navigates to a new page
  useEffect(() => {
    ...
    fetchSidebarBalance();
  }, [location.pathname]); // The dependency array ensures this runs on page change
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      {/* SIDEBAR: Added overflow-y-auto so it scrolls on smaller laptop screens */}
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-full overflow-y-auto">
        ...
        {/* Bottom Section: mt-auto pushes this to the bottom safely */}
        <div className="p-4 mt-auto shrink-0 space-y-2">
          
          {/* Live Virtual Cash Card */}
